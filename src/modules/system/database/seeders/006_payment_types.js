/**
 * Seeder: tipos de pago para Perú (dsg_bss_payment_types)
 */
const { PaymentType, Country } = require('../../models');
...
const seedFn = async (systemUserId) => {
    ...
    const paymentTypes = [
        ...
        { country_id: peru.country_id, name: 'Tarjeta de Crédito/Débito', code: 'CARD_ONLINE', category: 'tarjeta_credito', provider: 'Mercado Pago / Niubiz', description: 'Pago en línea con tarjeta Visa, Mastercard, AMEX, etc.', icon_url: null, processing_time: 'Inmediato', is_enabled: true, commission_percentage: 0.0399, fixed_commission: 1.00 }
    ];
